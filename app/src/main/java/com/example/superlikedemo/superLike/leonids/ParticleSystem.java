package com.example.superlikedemo.superLike.leonids;
...
import com.example.superlikedemo.superLike.leonids.initializers.AccelerationInitializer;
import com.example.superlikedemo.superLike.leonids.initializers.ParticleInitializer;
import com.example.superlikedemo.superLike.leonids.initializers.RotationInitializer;
import com.example.superlikedemo.superLike.leonids.initializers.RotationSpeedInitializer;
import com.example.superlikedemo.superLike.leonids.initializers.ScaleInitializer;
import com.example.superlikedemo.superLike.leonids.initializers.SpeedModuleAndRangeInitializer;
import com.example.superlikedemo.superLike.leonids.initializers.SpeeddByComponentsInitializer;
import com.example.superlikedemo.superLike.leonids.modifiers.AlphaModifier;
import com.example.superlikedemo.superLike.leonids.modifiers.ParticleModifier;
...
public class ParticleSystem {
    ...
    public ParticleSystem(ViewGroup parentView, Resources resources, int maxParticles, int[] drawableInts, long timeToLive) {
        ...
        if (drawableInts != null && drawableInts.length > 0) {
            for (int i = 0; i < mMaxParticles; i++) {
                Drawable drawable = resources.getDrawable(drawableInts[(int)(Math.random()*(10-1+1))]);
